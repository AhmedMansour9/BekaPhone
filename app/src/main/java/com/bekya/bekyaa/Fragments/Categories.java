package com.bekya.bekyaa.Fragments;
...
import com.bekya.bekyaa.Activites.All_Product;
import com.bekya.bekyaa.Activites.Cities;
import com.bekya.bekyaa.Activites.Home;
import com.bekya.bekyaa.Activites.ProductList;
import com.bekya.bekyaa.ChangeLanguage;
import com.bekya.bekyaa.Interface.Categories_View;
import com.bekya.bekyaa.Interface.CityId_View;
import com.bekya.bekyaa.Interface.itemViewinterface;
import com.bekya.bekyaa.ItemAnimation;
import com.bekya.bekyaa.Model.Cities_Response;
import com.bekya.bekyaa.Model.Gallery;
import com.bekya.bekyaa.Model.Category;
import com.bekya.bekyaa.Model.Companymodel;
import com.bekya.bekyaa.Interface.Open_Galler_View;
import com.bekya.bekyaa.Model.Retrivedata;
import com.bekya.bekyaa.Model.SubCategories_Model;
import com.bekya.bekyaa.R;
import com.bekya.bekyaa.adapter.Adapteritems;
import com.bekya.bekyaa.adapter.Slider_Adapter;
import com.bekya.bekyaa.adapter.Categories_Adapter;
import com.bekya.bekyaa.adapter.SubCategories_Adapter;
import com.bekya.bekyaa.adapter.imgclick;
import com.bekya.bekyaa.tokenid.SharedPrefManager;
...
//                vp_slider.setCurrentItem(page_position, true);
    ...
    void Filtertion(){
        ...
        if(Country!=null){
            ...
            SharedPrefManager.getInstance(getContext()).saveCountry("All");
            SharedPrefManager.getInstance(getContext()).saveCountryId("100");
            SharedPrefManager.getInstance(getContext()).saveCountryArabic("الكل");

            Home.T_Government.setText(getResources().getString(R.string.all));
...
//        getSubCategories(name);
    ...
    public void delete(String a) {
        ...
        if (!a .equals("null")) {
            ...
            Intent intent =
                    new Intent(Intent.ACTION_DIAL, Uri.fromParts("tel", a, null));
            startActivity(intent);
        }
    }
    ...
    public void GetImages(){
        ...
        data.orderByChild("cit_id").equalTo(SharedPrefManager.getInstance(getContext()).getCountryId()
        ...
        databaseReference.child("Category").addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                ...
                if (c != null && !hasCatId(c.getKey())) {
                    ...
                    recycler_Categories.setLayoutManager(linearLayoutManagersub);
