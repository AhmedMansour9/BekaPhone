...
//           }
   ...
   public void openPrivacy(){
       ...
       Privacy.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               startActivity(new Intent(Login.this, com.bekya.bekyaa.Activites.Privacy.class));
           }
       });
   }
    ...
    public void openRegister(){
        ...
        Btn_signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Login.this, com.bekya.bekyaa.Activites.Register.class));
            }
        });
    }
                        ...
                        if (task.isSuccessful()) {
                            ...
                            databaseReference.child( mAuth.getUid()).addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    ...
                                    hashMap.put("username",useer);
                                    hashMap.put("email",emaail);
                                    hashMap.put("f_name",useer);
                                    hashMap.put("f_last",useer);
                                    hashMap.put("type","1");
