package com.bekya.bekyaa.Activites;
...
import com.bekya.bekyaa.Model.Action;
import com.bekya.bekyaa.Model.Category;
import com.bekya.bekyaa.Model.Cities_Response;
import com.bekya.bekyaa.Model.CustomGallery;
import com.bekya.bekyaa.Model.Retrivedata;
import com.bekya.bekyaa.Model.SubCategories_Model;
import com.bekya.bekyaa.MyVolley;
import com.bekya.bekyaa.R;
import com.bekya.bekyaa.RequestPermissionListener;
import com.bekya.bekyaa.adapter.Adapteritems;
import com.bekya.bekyaa.adapter.Cities_Adapter;
import com.bekya.bekyaa.adapter.GalleryAdapter;
...
//        spinner_Types=findViewById(R.id.spinner_Types);
    ...
    void getCountries(final List<Cities_Response> tripsData){
        for (int i=0;i<tripsData.size();i++){
            if(tripsData.get(i).getId().equals("100")){
                tripsData.remove(i);
            }
        }
                ...
                if (dataT != null) {
                    ...
                    for (int i = 0; i < dataT.size(); i++) {
                     ...
                     //   Uri fi = Uri.parse(dataT.get(i).sdcardPath);
                        ...
                        storageRef = storage.getReferenceFromUrl("gs://new-bekya.appspot.com/");
