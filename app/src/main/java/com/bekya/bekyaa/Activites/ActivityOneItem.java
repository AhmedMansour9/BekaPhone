...
import com.bekya.bekyaa.Interface.btnclicks;
import com.bekya.bekyaa.Interface.imageclick;
import com.bekya.bekyaa.Model.Retrivedata;
import com.bekya.bekyaa.R;
import com.bekya.bekyaa.adapter.Banner_Adapter;
...
//                .addMedia(infos);
    ...
    private void init() {
        ...
        if(getIntent().getStringExtra("user_name").equals("Admin")){
            floatingT.setVisibility(View.INVISIBLE);
        }
