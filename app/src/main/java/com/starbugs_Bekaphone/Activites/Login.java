...
import com.starbugs_Bekaphone.Model.UserloginMain;
...
//           }
   ...
   public void openPrivacy(){
       ...
       Privacy.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               startActivity(new Intent(Login.this, com.starbugs_Bekaphone.Activites.Privacy.class));
           }
       });
   }
    ...
    public void openRegister(){
        ...
        Btn_signup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Login.this, com.starbugs_Bekaphone.Activites.Register.class));
            }
        });
    }
